...
#define g_fhctl_base 1  //only for build pass and will be remove after home screen
#define g_apmixed_base 1  //only for build pass and will be remove after home screen
#define g_ddrphy_base 1  //only for build pass and will be remove after home screen
...
#define REG_VCODECPLL_CON0  REG_APMIX_ADDR(0x0290)  ///< K2 FHCTL unsupport, VCODECPLL_CON0 is useless
...
#define REG_VCODECPLL_CON1  REG_APMIX_ADDR(0x0294)  ///< K2 FHCTL unsupport, VCODECPLL_CON0 is useless 
//****************************************************
