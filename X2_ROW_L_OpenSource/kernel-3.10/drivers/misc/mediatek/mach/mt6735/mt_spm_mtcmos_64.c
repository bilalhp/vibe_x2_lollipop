...
#define MD1_PROT_MASK        ( (0x1<<3) | (0x1<<4) | (0x1<<24) | (0x1<<25) | (0x1<<26) | (0x1<<27) | (0x1<<28)) //bit 3,4,24,25,26,27,28
#define MD2_PROT_MASK        ( (0x1<<17) | (0x1<<18) | (0x1<<29) | (0x1<<30) | (0x1<<31) )//bit 17,18, 29, 30, 31
#define DISP_PROT_MASK       ( (0x1<<1) | (0x1<<16) )//bit 1, 6, 16; if bit6 set, MMSYS PDN, access reg will hang
