...
//FIXME,
//wait MSDC bug fix
//if((mux->upd_mask == 0x2000) || (mux->upd_mask == 0x4000))
//	return;
...
static void cg_bootup_pdn(void)
{
    ...
    //INFRA CG
    clk_writel(INFRA_PDN_SET0, 0x0427B180);
    clk_writel(PERI_PDN_SET0, 0x4b0876);
...
static void mt_clks_init(void)
{
    ...
    clks[MT_CG_PERI_DISP_PWM].mux = &muxs[MT_MUX_PWM];
