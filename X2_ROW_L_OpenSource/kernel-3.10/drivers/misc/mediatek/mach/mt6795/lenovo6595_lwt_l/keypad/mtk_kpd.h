...
/*lenovo-sw louhs1 20140505 for long press power key reset  begin*/
#ifdef LENOVO_LONG_PRESS_POWERKEY_RESET
...
#define TWOKEY_REBOOT_OTHER_MODE
#endif
/*lenovo-sw louhs1 20140505 for long press power key reset  end*/
