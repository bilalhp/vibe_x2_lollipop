...
#endif
/*Begin lenovo sw-chailu1 add for usb eye diagram 2014-06-30*/
#define USB_EYE_DIAGRAM_TUNING
/*End lenovo sw-chailu1 add for usb eye diagram 2014-06-30*/
#ifdef FOR_BRING_UP
...
/*Begin lenovo sw-chailu1 add for usb eye diagram 2014-06-30*/	
#if defined(CONFIG_MTK_HDMI_SUPPORT) || defined(MTK_USB_MODE1) || defined(USB_EYE_DIAGRAM_TUNING)
	...
	U3PhyWriteField32(U3D_U2PHYACR4, E60802_RG_USB20_DM_100K_EN_OFST, E60802_RG_USB20_DM_100K_EN, 0);
/*Begin lenovo sw-chailu1 add for usb eye diagram 2014-06-30*/	
#if defined(USB_EYE_DIAGRAM_TUNING)
    os_printk(K_INFO, "%s- MHL USB PHY Settings.\n", __func__);
	U3PhyWriteField32(U3D_USBPHYACR5, E60802_RG_USB20_HS_100U_U3_EN_OFST, E60802_RG_USB20_HS_100U_U3_EN, 0);
	U3PhyWriteField32(U3D_USBPHYACR5, E60802_RG_USB20_VRT_VREF_SEL_OFST, E60802_RG_SSUSB_VRT_VREF_SEL, 5);
	U3PhyWriteField32(U3D_USBPHYACR5, E60802_RG_USB20_TERM_VREF_SEL_OFST, E60802_RG_USB20_TERM_VREF_SEL, 5);
#else
...
/*Begin lenovo sw-chailu1 add for usb eye diagram 2014-06-30*/
#ifdef USB_EYE_DIAGRAM_TUNING
	U3PhyWriteField32(U3D_USBPHYACR5, E60802_RG_USB20_HSTX_SRCTRL_OFST, E60802_RG_USB20_HSTX_SRCTRL, 1);
