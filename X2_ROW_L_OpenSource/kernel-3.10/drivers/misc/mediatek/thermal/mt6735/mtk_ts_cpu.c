...
////make for build pass 2014.11.24    mt_gpufreq_thermal_protect((final_limit != 0x7FFFFFFF) ? final_limit : 0);
}
...
{
	THERMAL_WRAP_WR32(0x0000000F, TEMPMONCTL0);            // enable periodoc temperature sensing point 0, point 1, point 2
}
...
static void thermal_config_Bank2_TS(void)
{
    ...
    //TSCON1[5:4]=2'b01
	//TSCON1[2:0]=3'b000
    THERMAL_WRAP_WR32(0x10,TEMPADCPNP3);                    // this value will be stored to TEMPPNPMUXADDR (TEMPSPARE0) automatically by hw
...
#if 1//make for build pass 2014.11.24
...
//make for build pass 2014.11.24	    if (!mtk_get_gpu_loading(&gpu_loading))
	        gpu_loading = 0;
...
#if 0//make for build pass 2014.11.24
...
//make for build pass 2014.11.24            mt_cpufreq_thermal_protect(700);
//make for build pass 2014.11.24            mt_gpufreq_thermal_protect(300);
...
//make for build pass 2014.11.24            mt_cpufreq_thermal_protect((final_limit != 0x7FFFFFFF) ? final_limit : 0);
