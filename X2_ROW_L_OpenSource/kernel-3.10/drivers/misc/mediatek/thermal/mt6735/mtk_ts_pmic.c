...
*/
    ...
    ret=pmic_config_interface(0x026A, 0x0040, 0xFFFF, 0); // new add
...
/*
	printk("read_6325_efuse: g_o_vts        = %x\n", g_o_vts);
    printk("read_6325_efuse: g_degc_cali    = %x\n", g_degc_cali);
    printk("read_6325_efuse: g_adc_cali_en  = %x\n", g_adc_cali_en);
    printk("read_6325_efuse: g_o_slope      = %x\n", g_o_slope);
    printk("read_6325_efuse: g_o_slope_sign = %x\n", g_o_slope_sign);
    printk("read_6325_efuse: g_id           = %x\n", g_id);


    printk("[read_6325_efuse] Done\n");
*/
}
...
//seq_printf(m,"6325/PMIC_Thermal: (efusevalue[0]>>15)&0x1        = 0x%x\n", (efusevalue[0]>>15)&0x1);
//seq_printf(m,"6325/PMIC_Thermal: ((efusevalue[1]&0x1F)<<1)        = 0x%x\n", ((efusevalue[1]&0x1F)<<1));
	 ...
	 //seq_printf(m,"6325/PMIC_Thermal: : efusevalue[0]=0x%x,efusevalue[1]=0x%x,efusevalue[2]=0x%x\n",efusevalue[0],efusevalue[1],efusevalue[2]);
	return 0;
}
