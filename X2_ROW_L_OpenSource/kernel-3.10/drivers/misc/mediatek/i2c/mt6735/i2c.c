...
/*
    ...
    g_dma_data[i2c->id].int_buf_size = (__raw_readl((void*)i2c->pdmabase+OFFSET_INT_BUF_SIZE));
    g_dma_data[i2c->id].debug_sta = (__raw_readl((void*)i2c->pdmabase+OFFSET_DEBUG_STA));
    g_dma_data[i2c->id].tx_4g_support = (__raw_readl((void*)i2c->pdmabase+OFFSET_TX_4G_SUPPORT));
    g_dma_data[i2c->id].rx_4g_support = (__raw_readl((void*)i2c->pdmabase+OFFSET_RX_4G_SUPPORT));
*/
}
