#ifndef _MT6735_M4U_REG_H__
#define _MT6735_M4U_REG_H__
...
#define REG_SMI_LARB_DOMN_OF_PORT(port)     (((port)>15) ? (((port)>23) ? 0xfdc : 0xfd8) : (((port)>7) ? 0xfd4 : 0xfd0)
    #define F_SMI_DOMN(port, domain)        (((domain)&0x3)<<(((port)>15) ? (((port)>23) ? ((port)-24) : ((port)-16)) : (((port)>7) ? ((port)-8) : (port))<<1))
