...
void mt_eint_set_hw_debounce(unsigned int gpio_pin, unsigned int ms)
{
	...
	eint_num = mt_gpio_to_irq(gpio_pin);
...
struct pin_node pins[EINT_MAX_CHANNEL + 1] =
{
	{.gpio_pin = 31, .eint_pin = 26},
	{.gpio_pin = 32, .eint_pin = 27},
	{.gpio_pin = 33, .eint_pin = 28},
	{.gpio_pin = 34, .eint_pin = 29},
	{.gpio_pin = 35, .eint_pin = 0},
	{.gpio_pin = 36, .eint_pin = 1},
	{.gpio_pin = 37, .eint_pin = 2},
	{.gpio_pin = 58, .eint_pin = 30},
	{.gpio_pin = 59, .eint_pin = 31},
	{.gpio_pin = 60, .eint_pin = 32},
	{.gpio_pin = 61, .eint_pin = 33},
	{.gpio_pin = 62, .eint_pin = 34},
	{.gpio_pin = 68, .eint_pin = 35},
	{.gpio_pin = 69, .eint_pin = 36},
	{.gpio_pin = 70, .eint_pin = 37},
	{.gpio_pin = 71, .eint_pin = 38},
	{.gpio_pin = 72, .eint_pin = 39},
	{.gpio_pin = 73, .eint_pin = 40},
	{.gpio_pin = 97, .eint_pin = 41},
	{.gpio_pin = 114, .eint_pin = 3},
	{.gpio_pin = 115, .eint_pin = 4},
	{.gpio_pin = 116, .eint_pin = 5},
	{.gpio_pin = 117, .eint_pin = 6},
	{.gpio_pin = 118, .eint_pin = 7},
	{.gpio_pin = 119, .eint_pin = 8},
	{.gpio_pin = 120, .eint_pin = 50},
	{.gpio_pin = 121, .eint_pin = 54},
	{.gpio_pin = 122, .eint_pin = 42},
	{.gpio_pin = 123, .eint_pin = 43},
	{.gpio_pin = 124, .eint_pin = 44},
	{.gpio_pin = 125, .eint_pin = 45},
	{.gpio_pin = 126, .eint_pin = 46},
	{.gpio_pin = 127, .eint_pin = 47},
	{.gpio_pin = 128, .eint_pin = 48},
	{.gpio_pin = 129, .eint_pin = 49},
	{.gpio_pin = 130, .eint_pin = 11},
	{.gpio_pin = 131, .eint_pin = 12},
	{.gpio_pin = 132, .eint_pin = 13},
	{.gpio_pin = 133, .eint_pin = 14},
	{.gpio_pin = 134, .eint_pin = 9},
	{.gpio_pin = 135, .eint_pin = 51},
	{.gpio_pin = 136, .eint_pin = 15},
	{.gpio_pin = 137, .eint_pin = 52},
	{.gpio_pin = 138, .eint_pin = 53},
	{.gpio_pin = 139, .eint_pin = 10},
	{.gpio_pin = 140, .eint_pin = 16},
	{.gpio_pin = 141, .eint_pin = 17},
	{.gpio_pin = 142, .eint_pin = 18},
	{.gpio_pin = 143, .eint_pin = 19},
	{.gpio_pin = 144, .eint_pin = 20},
	{.gpio_pin = 145, .eint_pin = 21},
	{.gpio_pin = 146, .eint_pin = 22},
	{.gpio_pin = 147, .eint_pin = 23},
	{.gpio_pin = 148, .eint_pin = 55},
	{.gpio_pin = 149, .eint_pin = 56},
	{.gpio_pin = 150, .eint_pin = 57},
	{.gpio_pin = 151, .eint_pin = 58},
	{.gpio_pin = 152, .eint_pin = 59},
	{.gpio_pin = 153, .eint_pin = 60},
	{.gpio_pin = 154, .eint_pin = 61},
	{.gpio_pin = 155, .eint_pin = 62},
	// GPIO# to 999 is impossible, end here
	{.gpio_pin = GPIO_MAX}
};
...
unsigned int special_eint_pin[3] = {24, 25, 63};
...
unsigned int mt_gpio_to_irq(unsigned int gpio)
{
	...
	for(i = 0; i < ARRAY_SIZE(special_eint_pin); i++) {
		if(gpio == special_eint_pin[i])
...
extern struct irq_domain_ops mt_eint_domain_simple_ops;
static int __init mt_eint_init(void)
{
    ...
    domain = irq_domain_add_legacy(node, EINT_MAX_CHANNEL, EINT_IRQ_BASE, 0,
                                &mt_eint_domain_simple_ops, eint_drv);
    if (!domain)
