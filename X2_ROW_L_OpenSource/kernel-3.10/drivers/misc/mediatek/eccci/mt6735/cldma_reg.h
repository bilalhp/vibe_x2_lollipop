...
#define CLDMA_AP_UL_START_ADDR_BK_0      (0x0804) // The start address of first TGPD descriptor for power-down back-up.
...
#define CLDMA_AP_UL_CURRENT_ADDR_BK_0    (0x0828) // The address of current processing TGPD descriptor for power-down back-up.
