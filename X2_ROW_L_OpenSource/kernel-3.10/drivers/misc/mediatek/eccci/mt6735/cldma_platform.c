...
void cldma_dump_register(struct ccci_modem *md)
{
    ...
    ccci_mem_dump(md->index, md_ctrl->cldma_ap_pdn_base+CLDMA_AP_SO_CFG, CLDMA_AP_DEBUG_ID_EN-CLDMA_AP_SO_CFG+4);
    ...
    ccci_mem_dump(md->index, md_ctrl->cldma_ap_pdn_base+CLDMA_AP_L2RIMR0, CLDMA_AP_DUMMY-CLDMA_AP_L2RIMR0+4);
    ...
    ccci_mem_dump(md->index, md_ctrl->cldma_md_pdn_base+CLDMA_AP_SO_CFG, CLDMA_AP_DEBUG_ID_EN-CLDMA_AP_SO_CFG+4);
    ...
    ccci_mem_dump(md->index, md_ctrl->cldma_md_pdn_base+CLDMA_AP_L2RIMR0, CLDMA_AP_DUMMY-CLDMA_AP_L2RIMR0+4);
...
int ccci_modem_resume(struct platform_device *dev)
{
	...
	CCCI_INF_MSG(md->index, TAG, "Resume cldma pdn register ...\n");
