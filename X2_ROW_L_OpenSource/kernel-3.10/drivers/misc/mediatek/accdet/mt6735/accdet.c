...
{ 
   ...
   //enable INT 
	...
	//pmic_pwrap_write(ACCDET_CTRL, (pmic_pwrap_read(ACCDET_CTRL))|(1<<4));
	//pmic_pwrap_write(ACCDET_DEFAULT_STATE_RG, (pmic_pwrap_read(ACCDET_DEFAULT_STATE_RG))|(1<<14));
   #endif
   #ifdef ACCDET_NEGV_IRQ
...
#endif
	 pmic_register_interrupt_callback(RG_ACCDET_IRQ_SET,accdet_int_handler);
	 pmic_register_interrupt_callback(RG_ACCDET_EINT_IRQ_SET,accdet_eint_int_handler);  
