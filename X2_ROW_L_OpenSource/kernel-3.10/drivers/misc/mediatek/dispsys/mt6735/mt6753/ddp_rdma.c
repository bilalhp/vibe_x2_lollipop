...
#else
  DISP_REG_SET(handle,idx*DISP_RDMA_INDEX_OFFSET+ DISP_REG_RDMA_MEM_GMC_SETTING_0, 0x1b013b86);
#endif
                    ...
                    void * handle)  // ourput setting
{
    ...
    if(input_is_yuv==1 && output_is_yuv==0)
    {
	    ...
	    DISP_REG_SET_FIELD(handle,SIZE_CON_0_FLD_MATRIX_INT_MTX_SEL, &size_con_reg, color_matrix);
...
void rdma_dump_analysis(DISP_MODULE_ENUM module)
{
    ...
    rdma_start_time=%lld ns,rdma_end_time=%lld ns\n",
