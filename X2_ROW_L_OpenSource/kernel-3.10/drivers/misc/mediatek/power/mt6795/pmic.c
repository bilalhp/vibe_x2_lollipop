...
void PMIC_INIT_SETTING_V1(void)
{
    ...
    if(mt6332_chip_version >= PMIC6332_E3_CID_CODE)
    {
        ...
        ret = pmic_config_interface(0x8426,0x10,0x7F,8); // [14:8]: VSRAM_DVFS2_VOSEL_OFFSET; YP                             OK
    ...
    else if(mt6332_chip_version >= PMIC6332_E1_CID_CODE)
    {
        ...
        ret = pmic_config_interface(0x8426,0x10,0x7F,8); // [14:8]: VSRAM_DVFS2_VOSEL_OFFSET; YP
...
void PMIC_INIT_SETTING_V2(void)
{
    ...
    if(mt6332_chip_version >= PMIC6332_E1_CID_CODE)
    {
        ...
        ret = pmic_config_interface(0x8426,0x10,0x7F,8); // [14:8]: VSRAM_DVFS2_VOSEL_OFFSET; Fandy 20140629 update
...
#define LENOVO_UVLO_2500_SUPPORT

#ifdef LENOVO_UVLO_2500_SUPPORT
void set_uvlo_2500mv(void)
{
    pmic_config_interface(0x18, 0xf, 0xf, 12);
    pmic_config_interface(0x8c1c, 0x3, 0x3, 14);
}
#endif
