...
// da9210 ata test
//=============================================================================
static ssize_t show_da9210_ata(struct device *dev,struct device_attribute *attr, char *buf)
{
    xlog_printk(ANDROID_LOG_INFO, "Power/PMIC","[show_da9210_ata] g_da9210_hw_exist=%d\n", g_da9210_hw_exist);
    return sprintf(buf, "%u\n", g_da9210_hw_exist);
}
static ssize_t store_da9210_ata(struct device *dev,struct device_attribute *attr, const char *buf, size_t size)
{        
    return size;
}
static DEVICE_ATTR(da9210_ata, 0664, show_da9210_ata, store_da9210_ata); //664
/*End lenovo-sw chailu1 add for ata test 2014-07-02*/	
...
/*Begin lenovo-sw chailu1 add for ata test 2014-07-02*/	
    ret_device_file = device_create_file(&(dev->dev), &dev_attr_da9210_ata);
/*End lenovo-sw chailu1 add for ata test 2014-07-02*/	
