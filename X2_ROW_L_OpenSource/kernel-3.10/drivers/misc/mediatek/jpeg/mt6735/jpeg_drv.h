...
#define JPEG_ENC_IOCTL_INIT         _IO    (JPEG_IOCTL_MAGIC, 12)                                                    
#define JPEG_ENC_IOCTL_CONFIG       _IOW   (JPEG_IOCTL_MAGIC, 13, JPEG_ENC_DRV_IN)                                   
#define JPEG_ENC_IOCTL_WAIT         _IOWR  (JPEG_IOCTL_MAGIC, 14, JPEG_ENC_DRV_OUT)                                  
#define JPEG_ENC_IOCTL_DEINIT       _IO    (JPEG_IOCTL_MAGIC, 15)                                                    
#define JPEG_ENC_IOCTL_START        _IO    (JPEG_IOCTL_MAGIC, 16)                                                    
...
#define COMPAT_JPEG_ENC_IOCTL_WAIT         _IOWR  (JPEG_IOCTL_MAGIC, 14, compat_JPEG_ENC_DRV_OUT)                                  
