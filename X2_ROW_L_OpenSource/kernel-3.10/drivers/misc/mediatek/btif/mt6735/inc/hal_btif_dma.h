...
#define TX_DMA_W_INT_BUF_SIZE(base)     (unsigned long)(base + 0x34)	/*BTIF Tx Virtual FIFO Internal Tx Write Buffer Size Register */
#define TX_DMA_INT_BUF_SIZE(base)       (unsigned long)(base + 0x38)	/*BTIF Tx Virtual FIFO Internal Tx Buffer Size Register */
