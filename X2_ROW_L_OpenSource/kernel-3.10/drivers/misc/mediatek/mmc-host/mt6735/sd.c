...
void msdc_dump_padctl(struct msdc_host *host)
{
	switch (host->id) {
		case 0:
			pr_err("MSDC0_GPIO_MODE18_ADDR[%p]		=0x%.8x",MSDC0_GPIO_MODE18_ADDR,sdr_read32(MSDC0_GPIO_MODE18_ADDR));
			pr_err("MSDC0_GPIO_MODE19_ADDR[%p]		=0x%.8x",MSDC0_GPIO_MODE19_ADDR,sdr_read32(MSDC0_GPIO_MODE19_ADDR));
			pr_err("MSDC0_GPIO_IES_G5_ADDR[%p]		=0x%.8x",MSDC0_GPIO_IES_G5_ADDR,sdr_read32(MSDC0_GPIO_IES_G5_ADDR));
			pr_err("MSDC0_GPIO_SMT_G5_ADDR[%p]		=0x%.8x",MSDC0_GPIO_SMT_G5_ADDR,sdr_read32(MSDC0_GPIO_SMT_G5_ADDR));
			pr_err("MSDC0_GPIO_TDSEL0_G5_ADDR[%p]	=0x%.8x",MSDC0_GPIO_TDSEL0_G5_ADDR,sdr_read32(MSDC0_GPIO_TDSEL0_G5_ADDR));
			pr_err("MSDC0_GPIO_RDSEL0_G5_ADDR[%p]	=0x%.8x",MSDC0_GPIO_RDSEL0_G5_ADDR,sdr_read32(MSDC0_GPIO_RDSEL0_G5_ADDR));
			pr_err("MSDC0_GPIO_DRV0_G5_ADDR[%p]		=0x%.8x",MSDC0_GPIO_DRV0_G5_ADDR,sdr_read32(MSDC0_GPIO_DRV0_G5_ADDR));
			pr_err("MSDC0_GPIO_PUPD0_G5_ADDR[%p]	=0x%.8x",MSDC0_GPIO_PUPD0_G5_ADDR,sdr_read32(MSDC0_GPIO_PUPD0_G5_ADDR));
			pr_err("MSDC0_GPIO_PUPD1_G5_ADDR[%p]	=0x%.8x",MSDC0_GPIO_PUPD1_G5_ADDR,sdr_read32(MSDC0_GPIO_PUPD1_G5_ADDR));
			break;
		case 1:
			pr_err("MSDC1_GPIO_MODE17_ADDR[%p]		=0x%.8x",MSDC1_GPIO_MODE17_ADDR,sdr_read32(MSDC1_GPIO_MODE17_ADDR));
			pr_err("MSDC1_GPIO_MODE18_ADDR[%p]		=0x%.8x",MSDC1_GPIO_MODE18_ADDR,sdr_read32(MSDC1_GPIO_MODE18_ADDR));
			pr_err("MSDC1_GPIO_IES_G4_ADDR[%p]		=0x%.8x",MSDC1_GPIO_IES_G4_ADDR,sdr_read32(MSDC1_GPIO_IES_G4_ADDR));
			pr_err("MSDC1_GPIO_SMT_G4_ADDR[%p]		=0x%.8x",MSDC1_GPIO_SMT_G4_ADDR,sdr_read32(MSDC1_GPIO_SMT_G4_ADDR));
			pr_err("MSDC1_GPIO_TDSEL0_G4_ADDR[%p]	=0x%.8x",MSDC1_GPIO_TDSEL0_G4_ADDR,sdr_read32(MSDC1_GPIO_TDSEL0_G4_ADDR));
			pr_err("MSDC1_GPIO_RDSEL0_G4_ADDR[%p]	=0x%.8x",MSDC1_GPIO_RDSEL0_G4_ADDR,sdr_read32(MSDC1_GPIO_RDSEL0_G4_ADDR));
			pr_err("MSDC1_GPIO_DRV0_G4_ADDR[%p]		=0x%.8x",MSDC1_GPIO_DRV0_G4_ADDR,sdr_read32(MSDC1_GPIO_DRV0_G4_ADDR));
			pr_err("MSDC1_GPIO_PUPD0_G4_ADDR[%p]	=0x%.8x",MSDC1_GPIO_PUPD0_G4_ADDR,sdr_read32(MSDC1_GPIO_PUPD0_G4_ADDR));
			break;
#ifdef CFG_DEV_MSDC2
		case 2:
			pr_err("MSDC2_GPIO_MODE20_ADDR[%p]		=0x%.8x",MSDC2_GPIO_MODE20_ADDR,sdr_read32(MSDC2_GPIO_MODE20_ADDR));
			pr_err("MSDC2_GPIO_MODE21_ADDR[%p]		=0x%.8x",MSDC2_GPIO_MODE21_ADDR,sdr_read32(MSDC2_GPIO_MODE21_ADDR));
			pr_err("MSDC2_GPIO_IES_G0_ADDR[%p]		=0x%.8x",MSDC2_GPIO_IES_G0_ADDR,sdr_read32(MSDC2_GPIO_IES_G0_ADDR));
			pr_err("MSDC2_GPIO_SMT_G0_ADDR[%p]		=0x%.8x",MSDC2_GPIO_SMT_G0_ADDR,sdr_read32(MSDC2_GPIO_SMT_G0_ADDR));
			pr_err("MSDC2_GPIO_TDSEL0_G0_ADDR[%p]	=0x%.8x",MSDC2_GPIO_TDSEL0_G0_ADDR,sdr_read32(MSDC2_GPIO_TDSEL0_G0_ADDR));
			pr_err("MSDC2_GPIO_RDSEL0_G0_ADDR[%p]	=0x%.8x",MSDC2_GPIO_RDSEL0_G0_ADDR,sdr_read32(MSDC2_GPIO_RDSEL0_G0_ADDR));
			pr_err("MSDC2_GPIO_DRV0_G0_ADDR[%p]		=0x%.8x",MSDC2_GPIO_DRV0_G0_ADDR,sdr_read32(MSDC2_GPIO_DRV0_G0_ADDR));
			pr_err("MSDC2_GPIO_PUPD0_G0_ADDR[%p]	=0x%.8x",MSDC2_GPIO_PUPD0_G0_ADDR,sdr_read32(MSDC2_GPIO_PUPD0_G0_ADDR));
			break;
#endif
	}
}
...
void msdc_dump_register(struct msdc_host *host)
{
	...
	INIT_MSG("Reg[%x] SDC_VOL_CHG    = 0x%.8x", OFFSET_SDC_VOL_CHG,    sdr_read32(SDC_VOL_CHG));
	...
	INIT_MSG("Reg[%x] MSDC_DMA_SA_HIGH4BIT = 0x%.8x", OFFSET_MSDC_DMA_SA_HIGH4BIT, sdr_read32(MSDC_DMA_SA_HIGH4BIT));
...
static void msdc_dump_clock_sts(struct msdc_host *host)
{
	...
	if(apmixed_reg_base1 && topckgen_reg_base ){ 
		...
		pr_err(" apmixed_reg_base1 = %p, topckgen_reg_base = %p", apmixed_reg_base1,topckgen_reg_base);
#endif
}
...
static void msdc_dump_ldo_sts(struct msdc_host *host)
{
    ...
    switch(host->id){
        case 0:
            ...
            INIT_MSG(" VEMC_EN[0x0A24]=0x%x, should:bit1=1, VEMC_VOL[0x0A64]=0x%x,should:[bit[5:4]=2b'01]\n", ldo_en, ldo_vol);
            break;
        case 1:
            pwrap_read( 0x0A20, &ldo_en );
            pwrap_read( 0x0A6A, &ldo_vol );
            INIT_MSG(" VMC_EN[0x0A20]=0x%x,  should:bit1=1, VMC_VOL[0x0A6A]=0x%x,should:bit[5:4]=2b'11(3.3V),2b'00(1.8V)\n", ldo_en, ldo_vol);
            pwrap_read( 0x0A1C, &ldo_en );
            pwrap_read( 0x0A66, &ldo_vol );
            INIT_MSG(" VMCH_EN[0x0A1C]==0x%x,should:bit1=1, VMCH_VOL[0x0A66]=0x%x,should:bit[5:4]=2b'10(3.3V)\n", ldo_en, ldo_vol);
            break;
        default:
            break;
    }
...
void msdc_set_driving(struct msdc_host *host, struct msdc_hw *hw, bool sd_18)
{
	switch(host->id){
		case 0:
			...
			sdr_set_field(MSDC0_GPIO_DRV0_G5_ADDR,MSDC0_DRV_DSL_MASK,hw->cmd_drv);
			...
			sdr_set_field(MSDC0_GPIO_DRV0_G5_ADDR,MSDC0_DRV_RSTB_MASK,hw->cmd_drv);
			break;
		case 1:
			if(sd_18){
...
#ifdef CFG_DEV_MSDC2 //FIXME: For 6630
		case 2:
			sdr_set_field(MSDC2_GPIO_DRV0_G0_ADDR,MSDC2_DRV_CMD_MASK,hw->cmd_drv_sd_18);
			sdr_set_field(MSDC2_GPIO_DRV0_G0_ADDR,MSDC2_DRV_CLK_MASK,hw->clk_drv_sd_18);
			sdr_set_field(MSDC2_GPIO_DRV0_G0_ADDR,MSDC2_DRV_DAT_MASK,hw->dat_drv_sd_18);
			break;
	...
	switch(host->id){
		case 0:
			if(MSDC_PIN_PULL_NONE == mode){			// high-Z
				...
				sdr_set_field(MSDC0_GPIO_PUPD1_G5_ADDR,MSDC0_PUPD_DAT57_RSTB_MASK,0x4444);
				...
				sdr_set_field(MSDC0_GPIO_PUPD1_G5_ADDR,MSDC0_PUPD_DAT57_RSTB_MASK,0x6666);
		...
		case 2:
			if(MSDC_PIN_PULL_NONE == mode){			// high-Z
				...
				sdr_set_field(MSDC2_GPIO_PUPD0_G0_ADDR,MSDC2_PUPD_CMD_CLK_DAT_MASK,0x111161);
			}
			break;
...
static void msdc_emmc_power(struct msdc_host *host,u32 on)
{
     ...
     * 4'b0101: -100 mV
     */
    msdc_ldo_power(on, MT6328_POWER_LDO_VEMC33, VOL_3300, &g_msdc0_flash);
    //mt6325_upmu_set_rg_vemc_3v3_cal(0x5);

#ifdef MTK_MSDC_BRINGUP_DEBUG
    pwrap_read( 0x0A18, &ldo_en );
    pwrap_read( 0x0A4A, &ldo_vol );
    printk("[%s]: msdc%d, VEMC_EN[0x0A18][bit1=1]=0x%d, VEMC_VOL[0x0A4A][bit9=1]=0x%x\n", __func__, host->id, ldo_en, ldo_vol);
#endif
...
#ifdef MTK_MSDC_BRINGUP_DEBUG
    pwrap_read( 0x0A54, &ldo_en );
    pwrap_read( 0x0A48, &ldo_vol );
    printk(KERN_ERR "[%s]: msdc%d, VMC_EN[0x0A54][bit1=1]=0x%d, VMC_VOL[0x0A48][bit1=1]=0x%x\n", __func__, host->id, ldo_en, ldo_vol);
    pwrap_read( 0x0A14, &ldo_en );
    pwrap_read( 0x0A48, &ldo_vol );
    printk(KERN_ERR "[%s]: msdc:%d, VMCH_EN[0x0A14][bit1=1]=0x%d, VMCH_VOL[0x0A48][bit9=1]=0x%x\n", __func__, host->id, ldo_en, ldo_vol);
...
static int msdc_dma_config(struct msdc_host *host, struct msdc_dma *dma)
{
	...
	case MSDC_MODE_DMA_DESC:
		...
		gpd->chksum = (chksum ? msdc_dma_calcs((u8 *) gpd, 16) : 0);
            ...
            trace_printk("[%s]: msdc%d, line:%d, bdlen=%d, size=%d\n", __func__, host->id, __LINE__, bdlen, dma->xfersz );
		/* modify bd */
		for (j = 0; j < bdlen; j++) {
...
static void emmc_hs400_backup(void)
{
    ...
    if(mtk_msdc_host[0]){
        base = mtk_msdc_host[0]->base;
        sdr_set_bits(EMMC50_CFG0,MSDC_EMMC50_CFG_TXSKEWSEL);
    }
...
static void emmc_hs400_restore(void)
{
    ...
    if(mtk_msdc_host[0]){
        base = mtk_msdc_host[0]->base;
        sdr_clr_bits(EMMC50_CFG0,MSDC_EMMC50_CFG_TXSKEWSEL);
    }
    for(i = 0; i < HS400_BACKUP_REG_NUM; i++)
    {
