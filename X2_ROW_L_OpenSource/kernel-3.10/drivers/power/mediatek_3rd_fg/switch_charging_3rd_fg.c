...
kal_uint32 set_bat_charging_current_limit(int current_limit)
{
	...
	/*Begin Lenovo-sw chailu1 add for thermal 2014-08-21*/
         #ifdef CONFIG_LENOVO_THERMAL_SUPPORT
...
/*Begin,Lenovo-sw chailu1 modify 2015-2-5, support TI's FG fuction*/
        ...
        else if(g_temp_CC_value == CHARGE_CURRENT_0_00_MA)
        {
		}
#endif
...
/*Begin lenovo sw-chailu1 add for po charging 2014-06-10*/
        ...
        {   
			if (is_po_ftm)
			{
                            g_temp_input_CC_value = AC_CHARGER_CURRENT;
                            g_temp_CC_value = AC_CHARGER_CURRENT;
			    printk("po charger current is 1000mA");
			}
			else
			{
        	            g_temp_input_CC_value = PO_CHARGER_CURRENT;	
                            g_temp_CC_value = PO_CHARGER_CURRENT;
			    printk("po charger current is 500mA");
...
/*Begin,Lenovo-sw chailu1 modify 2015-2-5, support TI's FG fuction*/
	...
	{	
        ...
        {
		    battery_xlog_printk(BAT_LOG_CRTI, " 45-50 check full !!\n\r");
			g_temp45_50_charger_full = KAL_TRUE;
		    return PMU_STATUS_OK; 
        }
        else
        {
