...
//default PRODUCT_STRING is VIBE X2
#define MANUFACTURER_STRING "Lenovo"
#define PRODUCT_STRING "VIBE X2"
...
#define LUN_NUM LUN_MULTI + LUN_SHARED_SD + LUN_ICUSB + 1
	...
	config->fsg.nluns = LUN_NUM+1;
      config->fsg.luns[0].cdrom = 1;
    #else
	config->fsg.nluns = LUN_NUM;
    #endif	
     /*Lenovo-sw yexh1 add for CD-Rom */ 
...
#endif
/*Lenovo-sw yexh1 add for CD-Rom, end */ 
...
/*Lenovo-sw yexh1 add 2014-10-21,add for CD-Rom */ 
#ifndef CONFIG_MTK_BICR_SUPPORT  
