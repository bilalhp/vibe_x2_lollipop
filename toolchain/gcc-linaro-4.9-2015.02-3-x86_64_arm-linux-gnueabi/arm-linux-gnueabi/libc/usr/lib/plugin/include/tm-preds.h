/* Generated automatically by the program 'build/genpreds'
   from the machine description file '/home/buildslave/workspace/BinaryRelease/label/hetzner/target/arm-linux-gnueabi/snapshots/gcc-linaro-4.9-2015.01-3/gcc/config/arm/arm.md'.  */
